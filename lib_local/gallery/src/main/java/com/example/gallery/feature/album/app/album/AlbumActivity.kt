...
import com.example.gallery.feature.album.viewmodel.data.AlbumTask
import com.example.gallery.feature.album.viewmodel.data.MediaReader
import com.example.gallery.feature.album.viewmodel.data.PathConversion
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CODE_ACTIVITY_NULL) {
            if (resultCode == RESULT_OK) {
                ...
                val mimeType = AlbumUtil.getMimeType(imagePath)
