...
//        when (refreshEnable) {
//            false -> {
//                root = context.inflate(R.layout.view_xrecycler)
//                recycler = root?.findViewById(R.id.rv_list)
//                if (emptyEnable) {
...
//            }
//            true -> {
//                root = context.inflate(R.layout.view_xrecycler_refresh)
//                refresh = root?.findViewById(R.id.refresh)
//                recycler = root?.findViewById(R.id.rv_list)
//                if (emptyEnable) {
//                    (root?.findViewById<FrameLayout>(R.id.fl_root))?.addView(empty)
//                    emptyConfigure()
//                }
//            }
//        }
