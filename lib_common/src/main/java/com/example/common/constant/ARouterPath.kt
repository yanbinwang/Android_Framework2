 ...
 */
object ARouterPath {
    const val MainActivity = "/main/main"
    const val LoginActivity = "/main/login"
    const val TestListActivity = "/main/testList"
    const val UserInfoActivity = "/main/userInfo" //    //main模块
