...
class XRecyclerView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : BaseViewGroup(context, attrs, defStyleAttr) {
    ...
    fun empty(resId: Int? = null, resText: Int? = null, resRefreshText: Int? = null, iconWidth: Int? = null, iconHeight: Int? = null) {
        empty.empty(resId, resText, resRefreshText, iconWidth, iconHeight)
    }
    ...
    fun error(resId: Int? = null, resText: Int? = null, resRefreshText: Int? = null, iconWidth: Int? = null, iconHeight: Int? = null) {
        empty.error(resId, resText, resRefreshText, iconWidth, iconHeight)
    }
    ...
    fun finish(isSuccessful: Boolean, resId: Int? = null, resText: Int? = null, resRefreshText: Int? = null, iconWidth: Int? = null, iconHeight: Int? = null) {
        empty.finish(isSuccessful, resId, resText, resRefreshText, iconWidth, iconHeight)
    }
