...
/**
 * 1.该类是单例类，将汉字转换成拼音
 * 2.定义了三个方法，demo中用到的是getSelling(String chs)方法，将词组转换成拼音
 */
class CharacterParser {
    ...
    companion object {
         ...
         */
        @JvmStatic
        val instance by lazy { CharacterParser() }
    }
    ...
    fun getSpelling(): String {
        return this.getSelling(this.resource.orEmpty())
    }
