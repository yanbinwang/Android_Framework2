 ...
 * 故下载的完成回调需要在线程内外做判断
 */
class DownloadFactory private constructor(override val coroutineContext: CoroutineContext) :
    CoroutineScope {

    companion object {
        @JvmStatic
        val instance: DownloadFactory by lazy {
            DownloadFactory(Dispatchers.IO)
        }
    }
    ...
    fun download(
        ...
        return launch {
            ...
            try {
                ...
                val body = getDownloadApi(downloadUrl)
