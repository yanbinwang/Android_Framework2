...
interface AdvertisingImpl {
     ...
     */
    fun start(uriList: ArrayList<String>, ovalLayout: LinearLayout? = null, triple: Triple<Int, Int, Int> = Triple(R.mipmap.ic_ad_select, R.mipmap.ic_ad_unselect, 10), localAsset: Boolean = false)
