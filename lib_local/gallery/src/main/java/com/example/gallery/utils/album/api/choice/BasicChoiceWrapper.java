...
import com.example.gallery.utils.album.api.album.BasicAlbumWrapper;
...
public abstract class BasicChoiceWrapper<Returner extends BasicChoiceWrapper, Result, Cancel, Checked> extends BasicAlbumWrapper<Returner, Result, Cancel, Checked> {
    ...
    public Filter<Long> mSizeFilter;
    public Filter<String> mMimeTypeFilter;
    public boolean mFilterVisibility = true;
