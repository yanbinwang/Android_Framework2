 ...
 * @author
 */
//class TestBottomDialog(activity: FragmentActivity) : BasePopupWindow<ViewDialogTestBottomBinding>(activity, popupHeight = MATCH_PARENT, popupAnimStyle = Companion.PopupAnimType.TRANSLATE, popupSlide = Gravity.TOP) {
