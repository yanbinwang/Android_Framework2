 ...
 */
package com.example.gallery.utils.album.api;
...
public final class Contract {
    ...
    public static  class AlbumView extends BaseView<AlbumPresenter> {
    ...
    public static class NullView extends BaseView<NullPresenter> {
