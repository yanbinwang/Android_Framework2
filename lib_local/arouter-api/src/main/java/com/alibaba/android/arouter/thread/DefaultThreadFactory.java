...
public class DefaultThreadFactory implements ThreadFactory {
    ...
    public Thread newThread(@NonNull Runnable runnable) {
        ...
        // 捕获多线程处理中的异常
        thread.setUncaughtExceptionHandler((thread1, ex) -> ARouter.logger.info(Consts.TAG, "Running task appeared exception! Thread [" + thread1.getName() + "], because [" + ex.getMessage() + "]"));
        return thread;
    }
