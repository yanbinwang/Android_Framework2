package com.example.gallery.album.app.gallery
...
import com.example.gallery.album.callback.ItemAction
import com.example.gallery.album.model.AlbumFile
import com.example.gallery.album.model.Widget
import com.example.gallery.album.utils.AlbumUtil.convertDuration
...
internal class GalleryAlbumActivity : BaseActivity(), Contract.GalleryPresenter {
    ...
    override fun onCurrentChanged(position: Int) {
        ...
        if (albumFile.mediaType == AlbumFile.TYPE_VIDEO) {
            ...
            mView.setDuration(convertDuration(albumFile.duration))
