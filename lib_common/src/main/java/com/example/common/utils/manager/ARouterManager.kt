...
//         */
//        @JvmStatic
//        fun handlerPush(isPush: Boolean = false) {
//            if (!isPush) return
//            val mContext = BaseApplication.instance.applicationContext
//            val clazz = mContext.getPostcardClass(ARouterPath.MainActivity)
//            val mainBuildAction = { isExist: Boolean ->
...
//                                ?.show()
//                        } else {
//                            linkHandler(if (type == 0) CHARGE_COIN else WITHDRAW_COIN, "", "")
//                        }
//                    }
//                } else {
//                    val aRouterPath = if (0 == type) ARouterPath.RechargeActivity else ARouterPath.WithdrawActivity
...
//                                            ?.show()
//                                    } else {
//                                        linkHandler(url, "2", if (hasPayWayAccount) "0" else "1")
//                                    }
//                                }
//                            }
//                        }
...
//     * 栈内拉起一个透明的页面用于显示弹框
//     */
//    private fun linkHandler(url: String?, id: String?, extras: String?) {
//        ARouter.getInstance().build(ARouterPath.LinkHandlerActivity)
//            .withString(Extra.SOURCE, "${url.orEmpty()}::${id.orEmpty()}::${extras.orEmpty()}")
//            .navigation()
//    }
